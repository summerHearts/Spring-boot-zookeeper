...
public class ZKGetChildrenList implements Watcher {
	...
	public static final String zkServerPath = "101.132.146.115:2181,101.132.146.115:2182,101.132.146.115:2183";
...
//		zkServer.getZookeeper().getChildren("/imooc", true, new ChildrenCallBack(), ctx);
		zkServer.getZookeeper().getChildren("/tapps", true, new Children2CallBack(), ctx);
